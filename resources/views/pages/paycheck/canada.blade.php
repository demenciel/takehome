<x-layouts.app :seo="$seo">
    ...
    <section class="mx-auto max-w-6xl px-4 py-10 sm:px-6">
        ...
        <p class="mt-4 max-w-3xl text-ink-soft">Canadian payroll deductions usually include federal income tax, provincial or territorial income tax, CPP or QPP, and EI. Quebec employees also pay QPIP and receive a federal tax abatement. This national calculator uses the current tax year ({{ $taxYear }}) and CRA T4127 Option 1 for a full-year employee claiming the basic personal amount.</p>
    </section>
